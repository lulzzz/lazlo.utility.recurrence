    ...
    public static class RecurOptsDataSource
    {
        ...
        public static IList DaysOfWeek
        {
            get
            {
                ...
                return new List<ListItem>(new[] {
                    new ListItem(Utility.Recurrence.DaysOfWeek.Sunday, dayNames[0]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Monday, dayNames[1]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Tuesday, dayNames[2]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Wednesday, dayNames[3]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Thursday, dayNames[4]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Friday, dayNames[5]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Saturday, dayNames[6]),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Weekdays, LR.EnumDesc(Utility.Recurrence.DaysOfWeek.Weekdays)),
                    new ListItem(Utility.Recurrence.DaysOfWeek.Weekends, LR.EnumDesc(Utility.Recurrence.DaysOfWeek.Weekends)),
                    new ListItem(Utility.Recurrence.DaysOfWeek.EveryDay, LR.EnumDesc(Utility.Recurrence.DaysOfWeek.EveryDay))
                });
            }
        }
